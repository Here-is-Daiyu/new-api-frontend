...
## 本次要实现的功能范围 / 任务项（2026-02-27 第五轮）

1. 顶部用户信息“额度”改为“当前值 / 500000”，并保留两位小数展示。
2. 日志审计统计“总消耗”改为“当前值 / 500000”，并保留两位小数展示。

## 本次任务完成情况（2026-02-27 第五轮）

- [x] 顶部用户信息“额度”改为“当前值 / 500000”，并保留两位小数展示。
- [x] 日志审计统计“总消耗”改为“当前值 / 500000”，并保留两位小数展示。
